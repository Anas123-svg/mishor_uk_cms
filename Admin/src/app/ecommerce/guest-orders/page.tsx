...
const OrdersPage = () => {
  ...
  const openModal = (order: GuestOrder) => {
  ...
  const handleStatusChange = async (orderId: number, newStatus: string) => {
    try {
      await axios.put(
        `${process.env.NEXT_PUBLIC_API_URL}/guest-orders/${orderId}`,
        { status: newStatus },
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  return (
    <DefaultLayout>
      <div className="relative mx-auto min-h-screen max-w-270">
        <Breadcrumb pageName="Guest Orders" />
        ...
        {selectedOrder && (
          ...
          >
            ...
            <div className="px-4 py-4 md:px-6 xl:px-7.5">
              ...
              <p className="text-white">
                <strong>Customer Name:</strong> {selectedOrder.guest_name}
              </p>
              <p className="text-white">
                <strong>Email:</strong> {selectedOrder.guest_email}
              </p>
              <p className="text-white">
                <strong>Phone:</strong> {selectedOrder.guest_phone}
              </p>
              <p className="text-white">
