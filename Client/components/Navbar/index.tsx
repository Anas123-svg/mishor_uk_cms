...
const Navbar = () => {
  ...
  return (
    <div className="flex gap-3 md:gap-5 top-0 z-50 fixed bg-white shadow-lg text-black border-b border-gray-200 px-6 md:px-12 lg:px-24 py-5 w-full">
      <div className="w-full flex items-center justify-between">
        <Link href="/">
          <img
            src={logo.src}
            alt="logo"
            className="w-28 sm:w-32 hover:scale-105 transition-transform duration-300"
          />
        </Link>
        ...
        <div className="hidden md:flex space-x-6 lg:space-x-12 items-center justify-center text-sm">
          ...
          >
            <Link
              href="/products"
              className="group flex items-center pb-1 border-b border-transparent hover:border-gray-900 transition-all duration-300 font-mons tracking-widest"
            >
              SHOP
              <VscChevronDown className="ml-1 group-hover:rotate-180 transition duration-300" />
            </Link>
            {activeDropdown && (
              <motion.div
